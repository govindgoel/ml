...
def plot_combined_output(gdf_input: gpd.GeoDataFrame, column_to_plot: str, font: str = 'DejaVu Serif', save_it: bool = False, number_to_plot: int = 0, is_predicted: bool = False, alpha:int=100):
    gdf = gdf_input.copy()
    ...
    # alpha = 10  # Adjust this parameter to make the shape tighter or looser
