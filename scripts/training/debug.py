...
dataset_path = os.path.join(
    "/home/dnguyen/gnn_predicting_effects_of_traffic_policies/",
    "data",
    "train_data",
    "edge_features_with_net_flow",
)
base_dir = os.path.join(
    "/home/dnguyen/gnn_predicting_effects_of_traffic_policies/", "data"
)
...
datalist = []
batch_num = 1
while True and batch_num < 2:  # Change this to "and batch_num < 10" for a faster run
